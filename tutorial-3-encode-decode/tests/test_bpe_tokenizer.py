...
class TestBPETokenizer:
    ...
    def test_encode_with_mixed_content(self):
        ...
        expected_ids = [tokenizer.inverse_vocab[c] for c in "hello"]
    ...
    def test_apply_merges_basic(self):
        ...
        tokenizer = BPETokenizer()
        text = "ababab"
        tokenizer.train(text, vocab_size=3)  # Will learn 'ab' merge
        
        # Initial token sequence before merges
    ...
    def test_apply_merges_no_applicable_rules(self):
        ...
        tokenizer = BPETokenizer()
        text = "abc"
        tokenizer.train(text, vocab_size=3)  # No merges possible with 3 unique chars
    ...
    def test_apply_merges_multiple_rules(self):
        ...
        tokenizer.train(text, vocab_size=7)  # Allow multiple merges
